...
const Menu = () => {
  ...
  return (
    <header className="header text-gray-700 dark:text-gray-200 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 fixed top-0 left-0 right-0 z-50">
      <div className="mx-auto flex h-16 max-w-7xl items-center px-4 md:px-6">
        ...
        <button
          type="button"
          className="ml-3 transition-colors duration-150 hover:text-primary-500"
          onClick={toggleTheme}
